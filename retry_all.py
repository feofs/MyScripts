...
#Кароч получается т.к Знерщт уж слишком сильно завязан на классах то и строка єто класс и когда мы присваиваем какое-то сртроковое значение пременной то создается класс со всеми аттрибуами и методаи
